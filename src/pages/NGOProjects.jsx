...
const NGOProjects = () => {
      ...
      events: [
        {
          ...
          eligibility: "Anyone with teaching experience",
          details: "Help distribute school supplies and conduct basic literacy classes"
        },
        {
          id: 2,
          name: "Math Workshop",
          ...
          eligibility: "Basic math knowledge, patience with children",
          details: "Conduct interactive math sessions for primary school students"
        }
      ]
    },
    {
      ...
      events: [
        {
          ...
          details: "Participate in beach cleaning and waste segregation"
        }
      ]
    },
    {
      ...
      description: "Promoting health awareness and providing basic healthcare services to underserved communities.",
      status: "upcoming",
      events: [
        {
          id: 1,
          ...
          eligibility: "Medical students or healthcare professionals",
          details: "Assist in conducting health check-ups and awareness sessions"
        }
      ]
    }
  ]);
  ...
  const renderProjectCard = (project) => {
    ...
    return (
      <div key={project.id} className="bg-white rounded-lg shadow-md overflow-hidden border border-green-100">
        <div className="p-6">
          ...
          <div className="mt-4 flex items-center justify-between">
            ...
            <div className="flex space-x-2">
              <button
                ...
                className="inline-flex items-center px-3 py-1 border border-transparent text-sm font-medium rounded-md text-white bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-600 hover:to-emerald-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500"
              >
  ...
  return (
    <div className="min-h-screen bg-green-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900">NGO Projects</h1>
          <p className="mt-2 text-sm text-gray-600">
            Manage your organization's projects and events
          </p>
        </div>
